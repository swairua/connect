  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        grace: "border-transparent bg-warning/15 text-warning font-medium",
        suspended: "border-transparent bg-destructive/15 text-destructive font-medium",
        paid: "border-transparent bg-success/15 text-success font-medium",
        pending: "border-transparent bg-warning/15 text-warning font-medium",
        overdue: "border-transparent bg-destructive/15 text-destructive font-medium",
      },
    },
    defaultVariants: {
      variant: "default",
